...
export class CurrentRideComponent implements OnInit, AfterViewChecked {
  ...
  private stompClientFinishedRide!: CompatClient;
  private stompClientFinishedRideSubscribe!: CompatClient;
  private stompClientPanic!: CompatClient;
