...
export class PanicService {
  private panic$ = new BehaviorSubject<string | null>(null);
  ...
  getWithStatus(rideNoStatus: RideNoStatusDTO): Ride {
    ...
    const ride: Ride = {
      babyTransport: rideNoStatus.babyTransport,
      driver: rideNoStatus.driver,
      endTime: rideNoStatus.endTime,
      estimatedTimeInMinutes: rideNoStatus.estimatedTimeInMinutes,
      id: rideNoStatus.id,
      locations: [{departure: rideNoStatus.locations[0].departure, destination: rideNoStatus.locations[0].destination}],
      passengers: passengerList,
      petTransport: rideNoStatus.petTransport,
      rejection: rideNoStatus.rejection,
      scheduledTime: rideNoStatus.scheduledTime,
      startTime: rideNoStatus.startTime,
      status: "FINISHED",
      totalCost: rideNoStatus.totalCost,
