...
export class MessagesComponent implements OnInit, OnDestroy {
  ...
  handleResult(message: { body: string }) {
    if (message.body) {
      ...
      const chat: Chat = this.chats.find(object => {
        return object.rideId === userMessage.rideId && (object.receiverId === userMessage.fromId || object.receiverId === Number(this.authService.getId()))
